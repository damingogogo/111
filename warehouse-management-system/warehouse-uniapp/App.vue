...
.status-claimed .status-dot { background: #3B82F6; }

.status-accepted {
  color: #6D28D9;
  background: #EDE9FE;
}
.status-accepted .status-dot { background: #8B5CF6; }

.status-shelved {
  color: #0E7490;
  background: #CFFAFE;
}
.status-shelved .status-dot { background: #06B6D4; }

.status-stored {
  color: #047857;
  background: #D1FAE5;
}
.status-stored .status-dot { background: #10B981; }
