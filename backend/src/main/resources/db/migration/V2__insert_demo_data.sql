insert ignore into admin_users(id, username, password, real_name, role, phone, avatar_url, status) values
...
insert ignore into departments(id, name, leader, description, image_url, status) values
...
insert ignore into employees(id, name, employee_no, phone, department_id, position, return_work_date, avatar_url, risk_level, status) values
...
insert ignore into screenings(id, title, description, push_cycle, estimated_minutes, cover_url, status) values
...
insert ignore into screening_questions(id, screening_id, content, dimension, sort_no, image_url, status) values
...
insert ignore into screening_reports(id, employee_id, screening_id, score, risk_level, summary, suggestion, chart_image_url, created_at) values
...
insert ignore into intervention_plans(id, risk_level, title, content, action_type, cover_url, status) values
...
insert ignore into courses(id, title, category, duration_minutes, summary, cover_url, status) values
...
insert ignore into course_progress(id, employee_id, course_id, progress, completed, last_viewed_at, image_url) values
...
insert ignore into consultants(id, name, title, speciality, phone, avatar_url, status) values
...
insert ignore into appointments(id, employee_id, consultant_id, appointment_time, method, status, notes, image_url) values
...
insert ignore into mood_logs(id, employee_id, mood_score, work_stress, family_stress, note, image_url, logged_at) values
...
insert ignore into policies(id, title, category, content, cover_url, status) values
...
insert ignore into system_settings(id, setting_key, setting_value, description, image_url) values
...
insert ignore into upload_files(id, file_name, object_name, url, content_type, size_bytes, biz_type) values
